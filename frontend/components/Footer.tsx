...
//        <div></div>
//        <div className='text-xl bg-slate-500 px-1 py-1 text-slate-100'>Crypto Aidol</div>
//      </div>
//      <div className='grid grid-cols-4 lg:grid lg:grid-cols-12 lg:gap-12'>
//        <div></div>
//        <div className='px-1 pb-2 text-slate-100 '><a href="/">Document</a></div>
//        <div className='px-3 pb-2 text-slate-100 '><a href="https://discord.gg/wVeXbdyB">Discord</a></div>
//        <div className='px-4 pb-2 text-slate-100 '><a href="https://twitter.com/crypto111977836">Twitter</a></div>
//      </div>
//    </footer>;
//    }
